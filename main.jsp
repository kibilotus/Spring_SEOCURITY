...
<table width="100%">
	<tr>
		<td colspan="<%= target_col %>">
		   <div align="right">
			...
			%>
					<i class="s1"><a href="/mvc/loginform">로그인</a>&nbsp;/&nbsp;<a href="/mvc/joinform">회원가입</a></i>
			<%
				} else {
			%>
    				<a href="/mvc/login"><%=session.getAttribute("loginUser")%>님의 My Page</a> |
				    <a href="/mvc/logout">로그아웃</a>
			<%
			}
			%>
	...
	<tr>
		<td colspan="<%= target_col %>">
			<center><a href="/mvc"><img src="${pageContext.request.contextPath}/resources/image/title.jpg"></img></a></center>
		</td>
	</tr>  
...
<tr>
	...
	<div class="drop_box">
			<ul>
				<li><a href="/mvc/consulting_main">Seocurity 컨설팅</a>
				<div class="sub_menu">
					<ul>
						<li><a href="/mvc/consulting_main">컨설팅 소개및 장점</a></li>
						<li><a href="/mvc/consulting_request">보안 컨설팅 신청</a></li>
					</ul>
				</div>
				</li>
				<li><a href="/mvc/consulting_sub1">주요정보통신기반시설 보호</a></li>
				<li><a href="/mvc/consulting_sub2">개인정보 보호</a></li>
				<li><a href="/mvc/consulting_sub3">정보보호 종합컨설팅</a></li>
				<li><a href="/mvc/consulting_sub4">시스템취약점진단</a></li>
			</ul>
	</div>
		</td>
	</tr>
